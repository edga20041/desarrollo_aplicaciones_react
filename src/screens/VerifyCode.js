...
const VerifyCode = ({ email, onVerificationSuccess }) => {
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            if (response.data.success) {
                showMessage("¡Verificación Exitosa! Tu cuenta ha sido verificada correctamente.", false);
                setTimeout(() => {
                    onVerificationSuccess();
                }, 1500);
            }
        } catch (err) {
            showMessage(err.response?.data?.message || 'Error al verificar el código', true);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleResendCode = async () => {
        ...
        try {
            ...
            setTimeLeft(60);
            setCanResend(false);
            showMessage("Se ha enviado un nuevo código a tu correo electrónico.", false);
        } catch (err) {
            showMessage(err.response?.data?.message || 'Error al reenviar el código', true);
        } finally {
            setLoading(false);
        }
    };
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={styles.infoContainer}>
                        ...
                        <Text style={[styles.infoText, { color: isDarkMode ? "#fff" : "#666" }]}>
                    ...
                    <View style={styles.timerContainer}>
                        <Text style={[styles.timerText, { color: isDarkMode ? "#fff" : "#666" }]}>
