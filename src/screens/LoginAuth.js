...
import { View, Text, TextInput, Pressable, StyleSheet, ActivityIndicator, Modal, StatusBar, ScrollView, Keyboard, Platform, Dimensions, TouchableOpacity } from 'react-native';
        ...
        >
            <SafeAreaView style={styles.container} edges={['top', 'right', 'left', 'bottom']}>
                ...
                >
                    ...
                    <Text style={[styles.title, { color: currentTheme.accent }]}>Iniciar Sesión</Text>
                    <View style={[styles.formContainer, { backgroundColor: 'transparent' }]}>
                        ...
                        />
                        {loading ? (
                            <ActivityIndicator size="large" color={currentTheme.accent} style={styles.loadingSpinner} />
                        ) : (
                            <Pressable
                                style={({ pressed }) => [
                                    styles.loginButton,
                    ...
                    <View style={styles.links}>
                        <Pressable onPress={() => navigation.navigate('RecoverPassword')}>
                            <Text style={[styles.link, { color: currentTheme.accent }]}>¿Olvidaste tu contraseña?</Text>
                        </Pressable>

                        <Pressable onPress={() => navigation.navigate('Register', { screen: 'Register' })}>
                            <Text style={[styles.link, { color: currentTheme.accent }]}>¿No tienes cuenta? Regístrate</Text>
                        </Pressable>
                    </View>
                </ScrollView>
                ...
                >
                    ...
                    >
                        <View style={[styles.modalContent, { backgroundColor: currentTheme.cardBg }]} onStartShouldSetResponder={() => true} onTouchEnd={(e) => e.stopPropagation()}>
                            ...
                            >
                                <LinearGradient colors={['#F27121', '#E94057']} style={styles.modalButtonGradient}>
